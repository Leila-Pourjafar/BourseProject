                ...
                c => new
                    {
                        ...
                        OpenInt = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Per = c.String(),
                        Open = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Last = c.Decimal(nullable: false, precision: 18, scale: 2),
                        DownloadFile_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.DownloadFiles", t => t.DownloadFile_Id)
                .Index(t => t.DownloadFile_Id);
